...
class _PersonalTodoState extends State<PersonalTodo> {
  bool value = false;
  int Personalcount = 0;
  final PersonalList = <ListModel>[];
  void _addTodoItem(String task) {
    if (task.isNotEmpty) {
      setState(() => PersonalList.add(ListModel(title: task)));
      Personalcount = PersonalList.length;
    }
  }
  double Personalpers = 0.0;
            ...
            children: [
              ...
              TextField(
                ...
                onSubmitted: (val) {
                  setState(() {
                    _addTodoItem(val);
                    Personalpers =  Personalpers + 0.05;
                  });
              ...
              children: [
                ...
                Align(
                    ...
                    child: Padding(
                        ...
                        child: Text('${(Personalpers * 100).round()}%',
            ...
            Expanded(
              child: ListView(
                children: [
                  ...
                  ...PersonalList.map(buildSingleCheckbox).toList(),
                ],
              ),
            ),
          ],
  ...
  Widget buildToggleCheckbox(ListModel notification) => buildCheckbox(
      ...
      onClicked: () {
        ...
        setState(() {
          PersonalList.forEach((notification) {
        ...
        onClicked: () {
          ...
          setState(() {
            ...
            if (!newValue) {
              ...
              final allow =
                  PersonalList.every((notification) => notification.value);
              ;
            }
          });
        },
